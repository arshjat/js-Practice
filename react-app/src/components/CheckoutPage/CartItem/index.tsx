...
export default React.memo((
  { productId, count, onDeleteHandler }:{productId:string, count:number, onDeleteHandler:Handler},
):React.ReactElement => {
      ...
      <div className="cart-item-ck" data-id={productId} data-count={count}>
        ...
        <div className="item-description-ck">
          ...
          <div className="product-price">
            ...
            <div>
              Total : ₹
              {count * Number(info.price.replace(',', ''))}
            </div>
          </div>
          {/* <hr width="96%" /> */}
          <div className="product-buttons">
            <button className="remove-button-ck" data-id={productId} onClick={onDeleteHandler} type="button">Remove</button>
            <button className="addToWishlist-button-ck" type="button">Add to Wishlist</button>
          </div>
        </div>
      </div>
    </>
